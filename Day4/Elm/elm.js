...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var day2part2 = function (input) {    return 0;};
   var day2part1 = function (input) {    return $Native$Native.md5(input);};
   var view = function (input) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A3($Html.node,
              "script",
              _U.list([A2($Html$Attributes.attribute,"src","https://cdnjs.cloudflare.com/ajax/libs/blueimp-md5/1.1.1/js/md5.js")]),
              _U.list([]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"Day 3 Part 1: ",$Basics.toString(day2part1(input))))]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"Day 3 Part 2: ",$Basics.toString(day2part2(input))))]))]));
   };
   var main = view("test");
   return _elm.Main.values = {_op: _op,main: main,view: view,day2part1: day2part1,day2part2: day2part2};
};
